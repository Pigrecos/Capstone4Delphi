...
Const
    //> Sub-flags of EFLAGS
    X86_EFLAGS_MODIFY_AF = 1;
    X86_EFLAGS_MODIFY_CF = 2;
    X86_EFLAGS_MODIFY_SF = 4;
    X86_EFLAGS_MODIFY_ZF = 8;
    X86_EFLAGS_MODIFY_PF = $10;
    X86_EFLAGS_MODIFY_OF = $20;
    X86_EFLAGS_MODIFY_TF = $40;
    X86_EFLAGS_MODIFY_IF = $80;
    X86_EFLAGS_MODIFY_DF = $100;
    X86_EFLAGS_MODIFY_NT = $200;
    X86_EFLAGS_MODIFY_RF = $400;
    X86_EFLAGS_PRIOR_OF  = $800;
    X86_EFLAGS_PRIOR_SF  = $1000;
    X86_EFLAGS_PRIOR_ZF  = $2000;
    X86_EFLAGS_PRIOR_AF  = $4000;
    X86_EFLAGS_PRIOR_PF  = $8000;
    X86_EFLAGS_PRIOR_CF  = $10000;
    X86_EFLAGS_PRIOR_TF  = $20000;
    X86_EFLAGS_PRIOR_IF  = $40000;
    X86_EFLAGS_PRIOR_DF  = $80000;
    X86_EFLAGS_PRIOR_NT  = $100000;
    X86_EFLAGS_RESET_OF  = $200000;
    X86_EFLAGS_RESET_CF  = $400000;
    X86_EFLAGS_RESET_DF  = $800000;
    X86_EFLAGS_RESET_IF  = $1000000;
    X86_EFLAGS_RESET_SF  = $2000000;
    X86_EFLAGS_RESET_AF  = $4000000;
    X86_EFLAGS_RESET_TF  = $8000000;
    X86_EFLAGS_RESET_NT  = $10000000;
    X86_EFLAGS_RESET_PF  = $20000000;
    X86_EFLAGS_SET_CF    = $40000000;
    X86_EFLAGS_SET_DF    = $80000000;
    X86_EFLAGS_SET_IF    = $100000000;
    X86_EFLAGS_TEST_OF   = $200000000;
    X86_EFLAGS_TEST_SF   = $400000000;
    X86_EFLAGS_TEST_ZF   = $800000000;
    X86_EFLAGS_TEST_PF   = $1000000000;
    X86_EFLAGS_TEST_CF   = $2000000000;
    X86_EFLAGS_TEST_NT   = $4000000000;
    X86_EFLAGS_TEST_DF   = $8000000000;
    X86_EFLAGS_UNDEFINED_OF = $10000000000;
    X86_EFLAGS_UNDEFINED_SF = $20000000000;
    X86_EFLAGS_UNDEFINED_ZF = $40000000000;
    X86_EFLAGS_UNDEFINED_PF = $80000000000;
    X86_EFLAGS_UNDEFINED_AF = $100000000000;
    X86_EFLAGS_UNDEFINED_CF = $200000000000;//‬(1 Shl 45);
...
type
 ...
 x86_xop_cc = (
  ...
  x86_prefix = (
    ...
    X86_PREFIX_REPE   =  $f3,	// repe/repz (cs_x86.prefix[0]
    X86_PREFIX_REPNE  =  $f2,  // repne/repnz (cs_x86.prefix[0]
  ...
  cs_x86_op = record
    ...
    size     : Byte;
    access   : Byte;
    avx_bcast: Cardinal;          // x86_avx_bcast
  ...
  cs_x86 = record
    ...
    sib      : Byte;
    disp     : Int64;
    sib_index: Cardinal;    // x86_reg
    sib_scale: Int8;        // int8_t
    sib_base : Cardinal;    // x86_reg
    xop_cc   : Integer;     // XOP Code Condition
    sse_cc   : Cardinal;     // x86_sse_cc
    avx_cc   : Cardinal;     // x86_avx_cc
    avx_sae  : Boolean;
    avx_rm   : Cardinal;     // x86_avx_rm
    eflags   : eFlags_;     // EFLAGS updated by this instruction.
	                          // This can be formed from OR combination of X86_EFLAGS_* symbols in x86.h
    op_count : Byte;
